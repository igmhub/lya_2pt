...
def compute_tracer_pair_dmat(
    ...
    if globals.get_old_distortion:
        ...
        etas, pixel_pairs_weights, pair_rp_eff, pair_rt_eff, pair_z_eff = get_etas(
            ...
            tracer1.order,
            tracer1.sum_weights,
            tracer1.logwave_term,
            tracer1.term3_norm,
            tracer2.weights,
            tracer2.z,
            tracer2.order,
            tracer2.sum_weights,
            tracer2.logwave_term,
            tracer2.term3_norm,
            unique_model_bins,
            pixel_pairs,
            rp_rt_pairs,
    ...
    # Compute new distortion matrix
        ...
        (
            ...
            pixel_pairs,
            rp_rt_pairs,
            tracer1.proj_vec_mat,
            tracer2.proj_vec_mat,
        )
...
def compute_outer_sum(
    ...
    weight1,
    weight2,
    kronecker1_forest2_slice,
    kronecker2_forest1_slice,
    forest1_forest2,
    vmat1_slice,
    vmat2_slice,
    vmat1_vmat2,
    ...
    for mbin_prime in range(mbin_size):
        ...
        pair_dmat_slice[mbin_prime] += (
            weight1 * kronecker1_forest2_sum
...
def get_general_pair_dmat(
    ...
    for (i, j, mbin, dbin), (weight1, weight2) in zip(pixel_pairs, pixel_pairs_weights):
        ...
        compute_outer_sum(
            pair_dmat[dbin],
            unique_model_bins.size,
            weight1,
            weight2,
            kronecker1_forest2[i],
            kronecker2_forest1[j],
            forest1_forest2,
            vmat1[i],
            vmat2[j],
            vmat1_vmat2,
